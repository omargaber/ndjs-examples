...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, authHeader, decoded, user_2, err_1, user;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 5:
                ...
                res.json(err_1);
                return [3 /*break*/, 6];
            case 6: return [4 /*yield*/, store.show(req.params.id)];
            case 7:
                user = _b.sent();
                res.json(user);
                return [2 /*return*/];
...
var showSavings = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var savings;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.showSavings(req.params.id)];
            case 1:
                savings = _a.sent();
                res.json(savings);
                return [2 /*return*/];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, authHeader, decoded, user, updatedUser, err_2;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
